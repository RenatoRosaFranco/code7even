  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Dashboard::Post" do
        expect {
          post :create, params: {dashboard_post: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {dashboard_post: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested dashboard_post" do
        post = Dashboard::Post.create! valid_attributes
        put :update, params: {id: post.to_param, dashboard_post: new_attributes}, session: valid_session
        post.reload
      ...
      it "redirects to the dashboard_post" do
        post = Dashboard::Post.create! valid_attributes
        put :update, params: {id: post.to_param, dashboard_post: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        post = Dashboard::Post.create! valid_attributes
        put :update, params: {id: post.to_param, dashboard_post: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
